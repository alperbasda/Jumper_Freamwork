...
public class EntityPropertyFeatureDefinitionConfiguration : IEntityTypeConfiguration<EntityPropertyFeatureDefinition>
{
    public void Configure(EntityTypeBuilder<EntityPropertyFeatureDefinition> builder)
    {
        builder.ToTable("EntityPropertyFeatureDefinitions").HasKey(t => t.Id);
