...
public class PropertyInputTypeDeclarationConfiguration : IEntityTypeConfiguration<PropertyInputTypeDeclaration>
{
    public void Configure(EntityTypeBuilder<PropertyInputTypeDeclaration> builder)
    {
        builder.ToTable("PropertyInputTypeDeclarations").HasKey(t => t.Id);
