...
public class MappingProfiles : Profile
{
    ...
    {
        CreateMap<CreateProjectDeclarationCommandWithOutCache, CreateProjectDeclarationCommand>().ReverseMap();
        ...
        CreateMap<Domain.MongoEntities.ProjectDeclaration, GetWithAllDetailByIdProjectDeclarationResponse>()
            .ForMember(w => w.Entities, q => q.Ignore())
            .ForMember(w => w.Relations, q => q.Ignore())
            .ForMember(w => w.Architecture, q => q.Ignore());
