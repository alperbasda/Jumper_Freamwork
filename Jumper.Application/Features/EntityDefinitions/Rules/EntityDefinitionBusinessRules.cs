...
public class EntityDefinitionBusinessRules : BaseBusinessRules
{
    ...
    public async Task AddDefaultProperties(Guid entityDefinitionId)
    {
        ...
        {
        new EntityPropertyDefinition { Id = Guid.NewGuid(),CreatedTime = DateTime.Now,EntityDefinitionId = entityDefinitionId,HasIndex = false,IsUnique = false,Name = "Id",PropertyTypeCode = "Guid" },
        new EntityPropertyDefinition { Id = Guid.NewGuid(),CreatedTime = DateTime.Now,EntityDefinitionId = entityDefinitionId,HasIndex = false,IsUnique = false,Name = "CreatedTime",PropertyTypeCode = "DateTime" },
        new EntityPropertyDefinition { Id = Guid.NewGuid(),CreatedTime = DateTime.Now,EntityDefinitionId = entityDefinitionId,HasIndex = false,IsUnique = false,Name = "UpdatedTime",PropertyTypeCode = "DateTime?" },
        new EntityPropertyDefinition { Id = Guid.NewGuid(),CreatedTime = DateTime.Now,EntityDefinitionId = entityDefinitionId,HasIndex = true,IsUnique = false,Name = "DeletedTime",PropertyTypeCode = "DateTime?" },
        };
