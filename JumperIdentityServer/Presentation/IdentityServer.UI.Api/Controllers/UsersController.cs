...
namespace IdentityServer.UI.Api.Controllers
{
    ...
    public class UsersController : MediatrController
    {
        ...
        {
            return Ok(Response<CreateUserResponse>.Success(await base.Mediator.Send(request), 200));
        }

        [HttpPut]
        public async Task<IActionResult> UpdateAsync(UpdateUserCommand request)
        {
            return Ok(Response<UpdateUserResponse>.Success(await base.Mediator.Send(request), 200));
        }
