...
public class BulkUpdateClientUserRelationCommandValidator : AbstractValidator<BulkUpdateClientUserRelationCommand>
{
    public BulkUpdateClientUserRelationCommandValidator()
    {
